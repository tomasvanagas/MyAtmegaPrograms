...
DALIKLIS++;
    ...
    DALIKLIS = 0;
        ...
        lcd_update_skaitiklis++;
                if(lcd_update_skaitiklis==1500){
                lcd_update_skaitiklis = 0;
                UPDATE_LCD = 1;
                }

        sek_skaitiklis++;
            if(sek_skaitiklis>=11155){
            UPDATE_LCD = 1;  
        ...
        OCR0 = sinusA[SIN_CIKLAS];
            ...
            OCR1A = 210 + SIN_CIKLAS - 60;
            }
            else if((SIN_CIKLAS>=105)&&(SIN_CIKLAS<150)){
            OCR1A = 254 - SIN_CIKLAS + 105;
            }
            else{
            OCR1A = 255;
            }*/          
        ...
        OCR1A = sinusB[SIN_CIKLAS];
            ...
            OCR2 = 210 + SIN_CIKLAS - 120;
            }
            else if(SIN_CIKLAS>=165){
            OCR2 = 254 - SIN_CIKLAS + 165; 
            }
            else if(SIN_CIKLAS<30){  
            OCR2 = 254 - SIN_CIKLAS - 15;
            }
            else{
            OCR2 = 255;
            }*/
