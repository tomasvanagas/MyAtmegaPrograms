...
; 0000 0035 // State7=T State6=T State5=T State4=T State3=T State2=T State1=0 State0=T
...
; 0000 004E // Mode: Ph. correct PWM top=00FFh
...
; 0000 0057 TCCR1A=0x81;
	LDI  R30,LOW(129)
	OUT  0x2F,R30
; 0000 0058 TCCR1B=0x02;
	LDI  R30,LOW(2)
	OUT  0x2E,R30
...
; 0000 007B // ADC Clock frequency: 1000,000 kHz
; 0000 007C // ADC Voltage Reference: AREF pin
; 0000 007D // Only the 8 most significant bits of
; 0000 007E // the AD conversion result are used
; 0000 007F ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 0080 ADCSRA=0x83;
	LDI  R30,LOW(131)
	OUT  0x6,R30
; 0000 0081 
...
; 0000 0083 #asm("sei")
	sei
; 0000 0084 static unsigned char a;
; 0000 0085     while(1){
_0x6:
; 0000 0086         if(read_adc(0)>OCR1A){
	RCALL SUBOPT_0x0
	CP   R30,R26
	CPC  R31,R27
	BRSH _0x9
; 0000 0087         OCR1A++;
	...
	RJMP _0xD
; 0000 0088         }
; 0000 0089         else if(read_adc(0)<OCR1A){
_0x9:
	RCALL SUBOPT_0x0
	CP   R26,R30
	CPC  R27,R31
