...
; 0000 0331         BATTERY_VOLTAGE_ARCHIVE[i] = BATTERY_VOLTAGE_ARCHIVE[i-1];
	LDI  R27,0
	SUBI R26,LOW(-_BATTERY_VOLTAGE_ARCHIVE)
	SBCI R27,HIGH(-_BATTERY_VOLTAGE_ARCHIVE)
	LD   R30,Y
	LDI  R31,0
	SBIW R30,1
	SUBI R30,LOW(-_BATTERY_VOLTAGE_ARCHIVE)
	SBCI R31,HIGH(-_BATTERY_VOLTAGE_ARCHIVE)
	LD   R30,Z
	ST   X,R30
; 0000 0332         }
	LD   R30,Y
...
; 0000 0543                 LangoAdresas++;
	LDS  R30,_LangoAdresas
	SUBI R30,-LOW(1)
	STS  _LangoAdresas,R30
; 0000 0544                     if(LangoAdresas>4){
	LDS  R26,_LangoAdresas
	CPI  R26,LOW(0x5)
	BRLO _0x1A7
