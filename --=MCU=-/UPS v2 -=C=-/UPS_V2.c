...
// Kai pasijungia ir buna nesamoningi skaiciai reikia nuresetint i default'us  
    ...
    if(Timer18>168){ StartDischargeAfter(7,0,0,0);}
    
    if(MAX_BATTERY_VOLTAGE>=200){MAX_BATTERY_VOLTAGE = 146;}
    
    if(MIN_BATTERY_VOLTAGE>=200){MIN_BATTERY_VOLTAGE = 110;}
/////////////////////////////////////////////////////////////////////////////    
...
/////////////////////// UPS STATUSAS ///////////////////////////////////////////////
        if(UPS_STATE==0){
        // Nulinis statusas       
        unsigned char NulinioStatusoPadetis;
