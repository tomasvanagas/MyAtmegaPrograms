...
{if((pfet_kairysis==1)&&(PORTB.4==0)){
PORTB.4 = 0;
PORTB.1 = 1;}
else
PORTB.1 = 0;}
{if((pfet_desinysis==1)&&(PORTB.3==0)){
PORTB.3 = 0;
PORTB.2 = 1;}
else
PORTB.2 = 0;}
{if((nfet_desinysis==1)&&(PORTB.2==0)){
PORTB.2 = 0;
PORTB.3 = 1;}
else
PORTB.3 = 0;}
{if((nfet_kairysis==1)&&(PORTB.1==0)){
PORTB.1 = 0;
PORTB.4 = 1;}
else
PORTB.4 = 0;}}
...
void mosfet_valdymas(){
if((viena_laikrodzio_sekunde<PUSE_SEKUNDES)&&
(viena_laikrodzio_sekunde>0)){
pfet_desinysis = 0;
nfet_kairysis = 0;
