...
; 0000 0040 // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=In Func1=In Func0=Out
; 0000 0041 // State7=T State6=T State5=T State4=T State3=T State2=T State1=T State0=0
...
; 0000 0088 // ADC Auto Trigger Source: None
; 0000 0089 ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 008A ADCSRA=0x83;
	LDI  R30,LOW(131)
	OUT  0x6,R30
; 0000 008B 
; 0000 008C /*
; 0000 008D // Watchdog Timer initialization
; 0000 008E // Watchdog Timer Prescaler: OSC/16k
; 0000 008F #pragma optsize-
; 0000 0090 WDTCR=0x18;
; 0000 0091 WDTCR=0x08;
...
; 0000 009E     PORTC.0 = 0;
	CBI  0x15,0
; 0000 009F     read_adc(0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	RCALL _read_adc
; 0000 00A0     PORTC.0 = 1;
	SBI  0x15,0
; 0000 00A1     read_adc(0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	RCALL _read_adc
; 0000 00A2     };
