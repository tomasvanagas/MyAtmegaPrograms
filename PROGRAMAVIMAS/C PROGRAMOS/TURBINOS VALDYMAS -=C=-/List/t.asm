...
; 0000 0086 
; 0000 0087           // PROGRAMA
; 0000 0088       if(AUKSTUTINE_ITAMPA==1){
_0x36:
	CPI  R16,1
	BRNE _0x37
; 0000 0089       KONDENCATORIAUS_ISKROVIMAS = 1;}
	LDI  R18,LOW(1)
; 0000 008A 
...
; 0000 008D 
; 0000 008E 
; 0000 008F       {if((KONDENCATORIAUS_ISKROVIMAS==1)&&(OSC==0)){
_0x38:
	CPI  R18,1
	BRNE _0x3A
	CPI  R19,0
...
_0x3A:
	RJMP _0x39
_0x3B:
; 0000 0090       LYGIAGRECIAI = 1;}
	LDI  R20,LOW(1)
; 0000 0091       else
	RJMP _0x3C
_0x39:
; 0000 0092       LYGIAGRECIAI = 0;}
	LDI  R20,LOW(0)
_0x3C:
; 0000 0093 
; 0000 0094       {if((KONDENCATORIAUS_ISKROVIMAS==1)&&(OSC==3)){
	CPI  R18,1
	BRNE _0x3E
	CPI  R19,3
	BREQ _0x3F
_0x3E:
	RJMP _0x3D
_0x3F:
; 0000 0095       NUOSEKLIAI = 1;}
	LDI  R21,LOW(1)
; 0000 0096       else
	RJMP _0x40
_0x3D:
; 0000 0097       NUOSEKLIAI = 0;}
	LDI  R21,LOW(0)
_0x40:
; 0000 0098 
; 0000 0099 
; 0000 009A           // ISEJIMAI
; 0000 009B       {if(LYGIAGRECIAI==1){
	CPI  R20,1
	BRNE _0x41
; 0000 009C       PORTD.3 = 1;
	SBI  0x12,3
...
; 0000 00A6 
; 0000 00A7 
; 0000 00A8             // FILTRAVIMAS
; 0000 00A9       ZEMUTINE_ITAMPA = 0;
	LDI  R17,LOW(0)
; 0000 00AA       AUKSTUTINE_ITAMPA = 0;
	LDI  R16,LOW(0)
; 0000 00AB       }
; 0000 00AC while(1);}
	RJMP _0x34
