...
; 0000 0082 
; 0000 0083 
; 0000 0084 // read_adc(0) - 12V (182 bit = 14.3V)
; 0000 0085 // read_adc(1) - Potenciometras
; 0000 0086 // read_adc(2) - 48V
; 0000 0087 
; 0000 0088 
; 0000 0089 
; 0000 008A #define ZADINIMAS OCR0
; 0000 008B #define KROVIMAS OCR1A
; 0000 008C 
; 0000 008D 
; 0000 008E     while(1){
_0x6:
; 0000 008F         if(read_adc(0)<178){
	LDI  R30,LOW(0)
	ST   -Y,R30
	RCALL _read_adc
	CPI  R30,LOW(0xB2)
	BRSH _0x9
; 0000 0090             if(ZADINIMAS<255){
	IN   R30,0x3C
	CPI  R30,LOW(0xFF)
	BRSH _0xA
; 0000 0091             ZADINIMAS++;
...
; 0000 0093         }
_0xA:
; 0000 0094         else if(read_adc(0)<182){
	RJMP _0xB
_0x9:
	LDI  R30,LOW(0)
	ST   -Y,R30
